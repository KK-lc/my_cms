...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            <form class="form-horizontal" action="${path}/article?cmd=add" method="post" >
                <!-- 文章标题-->
                <div class="form-group">
                    <label for="articleTitle" class="col-lg-2 control-label">标题</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="articleTitle"  name="articleTitle" placeholder="输入标题">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="articleType" class="col-lg-2 control-label">文章类型</label>
                    <div class="col-lg-10">
                        <select class="form-control" name="articleState" id="articleState">
                            <option value="-1">请选择</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <textarea rows="30" cols="62" name="articleContent" id="articleContent" class="form-control ckeditor"></textarea>
                    </div>
                </div>
