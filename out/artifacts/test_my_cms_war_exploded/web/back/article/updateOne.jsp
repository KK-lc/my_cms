    ...
    <div class="row">
        <div>
            <ol class="breadcrumb">
                ...
                <li><a href="${path}/article?cmd=listOne">文章类型管理</a></li>
                <li class="active">文章类型修改</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            <form class="form-horizontal" action="${path}/article?cmd=updateOne&aIdOne=${articleType.typeId}" method="post" >
                <!-- 文章标题-->
                <div class="form-group">
                    <label for="typeId" class="col-lg-2 control-label">文章名字</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="typeId" value="${articleType.typeId}" name="typeId" placeholder="输入文章名字">
                    </div>
                </div>

                <!-- 演示初始化下拉列表的功能 -->
                <div class="form-group">
                    <label for="articleType" class="col-lg-2 control-label">文章内容</label>
                    <div class="col-lg-10">
